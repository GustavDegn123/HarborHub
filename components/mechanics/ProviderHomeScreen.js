// /components/mechanics/ProviderHomeScreen.js
  ...
  return (
    <View style={styles.screen}>
      ...
      <View style={styles.card}>
        ...
        {/* 👇 NY KNAP: Mine opgaver (tildelte jobs) */}
        <TouchableOpacity
          style={styles.ctaPrimary}
          onPress={() => navigation.navigate("AssignedJobs")}
        >
          <Text style={styles.ctaPrimaryText}>Mine opgaver</Text>
        </TouchableOpacity>
      ...
      <View style={styles.footer}>
        <Text style={styles.footerText}>Bygget med kærlighed til sejlere</Text>
      </View>
    </View>
  );
}